...
#Drifted Data 4 
region1 <- cbind(r1 * cos(theta1) + 0.55, r1 * sin(theta1) + 0.6)
region2 <- cbind(r2 * cos(theta2) + 0.35, r2* sin(theta2) + 0.4)
data <- rbind(region1,region2)
data_df5 <- data.frame(data,class=as.factor(c(rep(1,N),rep(2,N)))) 

#Drifted Data 5 
region1 <- cbind(r1 * cos(theta1) + 0.55, r1 * sin(theta1) + 0.4)
region2 <- cbind(r2 * cos(theta2) + 0.35, r2* sin(theta2) + 0.6)
data <- rbind(region1,region2)
data_df6 <- data.frame(data,class=as.factor(c(rep(1,N),rep(2,N)))) 
...
plot(data_df4$X1,data_df4$X2,col=data_df4$class,pch =16,xlab='X1',ylab='X2',main = "Drifted Data 3",
     xlim = c(0,1),ylim=c(0,1))
plot(data_df5$X1,data_df5$X2,col=data_df5$class,pch =16,xlab='X1',ylab='X2',main = "Drifted Data 4",
     xlim = c(0,1),ylim=c(0,1))
plot(data_df6$X1,data_df6$X2,col=data_df6$class,pch =16,xlab='X1',ylab='X2',main = "Drifted Data 5",
     xlim = c(0,1),ylim=c(0,1))
